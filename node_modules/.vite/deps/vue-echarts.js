...
import "./chunk-Z7YFA6BR.js";
import "./chunk-EOB5YA76.js";
import {
  init,
  throttle
} from "./chunk-ATY7X6PD.js";
import "./chunk-HC5BKWP6.js";
import {
  Vue2
} from "./chunk-UKHMGTLK.js";
import {
  computed,
  defineComponent,
  getCurrentInstance,
...
var S = defineComponent({ name: "echarts", props: O(O({ option: Object, theme: { type: [Object, String] }, initOptions: Object, updateOptions: Object, group: String, manualUpdate: Boolean }, _), L), emits: {}, inheritAttrs: false, setup: function(t, i) {
  ...
  watch(C2, function(n) {
    "function" == typeof N && (N(), N = null), n || (N = watch(function() {
      ...
      e && (b2.value ? b2.value.setOption(e, O({ notMerge: e.value !== (null == t2 ? void 0 : t2.value) }, P.value)) : F());
    }, { deep: true }));
