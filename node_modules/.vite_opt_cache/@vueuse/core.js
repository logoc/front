import { $ as shallowRef, h as watchEffect, J as readonly, a0 as unref, r as ref, w as watch, a1 as customRef, a2 as getCurrentScope, a3 as onScopeDispose, a4 as effectScope, Y as isRef, c as computed, a as reactive, D as toRef, t as toRefs$1, g as getCurrentInstance, a5 as onBeforeMount, C as nextTick, A as onBeforeUnmount, o as onMounted, f as onUnmounted, B as provide, i as inject, a6 as isReactive, I as onUpdated, a7 as markRaw, a8 as onBeforeUpdate } from '../common/runtime-dom.esm-bundler-74b89f18.js';
...
function useRefHistory(source, options = {}) {
  ...
  const manualHistory = useManualRefHistory(source, __spreadProps$6$1(__spreadValues$g({}, options), { clone: options.clone || deep, setSource }));
  ...
  return __spreadProps$6$1(__spreadValues$g({}, manualHistory), {
    isTracking,
    pause,
    resume,
    commit,
...
function useDebouncedRefHistory(source, options = {}) {
  ...
  const history = useRefHistory(source, __spreadProps$5$1(__spreadValues$f({}, options), { eventFilter: filter }));
...
function useDraggable(target, options = {}) {
  ...
  return __spreadProps$4$1(__spreadValues$e({}, toRefs(position)), {
    position,
...
function useResizeObserver(target, callback, options = {}) {
  const _a = options, { window = defaultWindow } = _a, observerOptions = __objRest$2$1(_a, ["window"]);
  let observer;
  ...
  function useFactoryFetch(url, ...args) {
    ...
    if (args.length > 0) {
      if (isFetchOptions(args[0])) {
        options = __spreadProps$3$1(__spreadValues$c(__spreadValues$c({}, options), args[0]), {
          beforeFetch: combineCallbacks(_combination, _options.beforeFetch, args[0].beforeFetch),
          afterFetch: combineCallbacks(_combination, _options.afterFetch, args[0].afterFetch),
          onFetchError: combineCallbacks(_combination, _options.onFetchError, args[0].onFetchError)
        });
      } else {
        fetchOptions = __spreadProps$3$1(__spreadValues$c(__spreadValues$c({}, fetchOptions), args[0]), {
          headers: __spreadValues$c(__spreadValues$c({}, headersToObject(fetchOptions.headers) || {}), headersToObject(args[0].headers) || {})
        });
      }
    }
    if (args.length > 1 && isFetchOptions(args[1])) {
      options = __spreadProps$3$1(__spreadValues$c(__spreadValues$c({}, options), args[1]), {
...
function useFetch(url, ...args) {
  ...
  const execute = async (throwOnFailed = false) => {
    ...
    if (supportsAbort) {
      ...
      fetchOptions = __spreadProps$3$1(__spreadValues$c({}, fetchOptions), {
    ...
    return new Promise((resolve, reject) => {
      var _a3;
      fetch(context.url, __spreadProps$3$1(__spreadValues$c(__spreadValues$c({}, defaultFetchOptions), context.options), {
  ...
  function setMethod(method) {
    return (payload, payloadType) => {
      if (!isFetching.value) {
        ...
        return __spreadProps$3$1(__spreadValues$c({}, shell), {
...
const useImage = (options, asyncStateOptions = {}) => {
  const state = useAsyncState(() => loadImage(resolveUnref(options)), void 0, __spreadValues$9$1({
    resetOnExecute: true
  }, asyncStateOptions));
...
function useInfiniteScroll(element, onLoadMore, options = {}) {
  ...
  const state = reactive(useScroll(element, __spreadProps$2$1(__spreadValues$8$1({}, options), {
    offset: __spreadValues$8$1({
...
function useMediaControls(target, options = {}) {
  options = __spreadValues$7$1(__spreadValues$7$1({}, defaultOptions), options);
  const {
    document = defaultDocument
  } = options;
...
var __objRest$1$1 = (source, exclude) => {
  var target = {};
  for (var prop in source)
    if (__hasOwnProp$7$1.call(source, prop) && exclude.indexOf(prop) < 0)
      target[prop] = source[prop];
  if (source != null && __getOwnPropSymbols$7$1)
    for (var prop of __getOwnPropSymbols$7$1(source)) {
      if (exclude.indexOf(prop) < 0 && __propIsEnum$7$1.call(source, prop))
        target[prop] = source[prop];
    }
  return target;
};
function useMutationObserver(target, callback, options = {}) {
  const _a = options, { window = defaultWindow } = _a, mutationOptions = __objRest$1$1(_a, ["window"]);
  let observer;
...
var __spreadValues$6$1 = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$6$1.call(b, prop))
      __defNormalProp$6$1(a, prop, b[prop]);
  if (__getOwnPropSymbols$6$1)
    for (var prop of __getOwnPropSymbols$6$1(b)) {
      if (__propIsEnum$6$1.call(b, prop))
        __defNormalProp$6$1(a, prop, b[prop]);
    }
  return a;
};
...
function usePointer(options = {}) {
  ...
  return __spreadProps$1$1(__spreadValues$5$1({}, toRefs(state)), {
    isInside
  });
}
...
function useShare(shareOptions = {}, options = {}) {
  ...
  const share = async (overrideOptions = {}) => {
    if (isSupported.value) {
      const data = __spreadValues$4$1(__spreadValues$4$1({}, resolveUnref(shareOptions)), resolveUnref(overrideOptions));
      let granted = true;
...
function useThrottledRefHistory(source, options = {}) {
  ...
  const history = useRefHistory(source, __spreadProps$a(__spreadValues$3$1({}, options), { eventFilter: filter }));
  return __spreadValues$3$1({}, history);
}
...
function useTimeAgo(time, options = {}) {
  ...
  const _a = useNow({ interval: updateInterval, controls: true }), { now } = _a, controls = __objRest$6(_a, ["now"]);
...
const TransitionPresets = __spreadValues$n({
  linear: identity
}, _TransitionPresets);
