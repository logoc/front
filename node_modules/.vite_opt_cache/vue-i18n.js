import { F as Fragment, X as h, a4 as effectScope, i as inject, o as onMounted, f as onUnmounted, $ as shallowRef, r as ref, c as computed, a5 as onBeforeMount, g as getCurrentInstance, w as watch, Y as isRef, v as createVNode, at as Text } from './common/runtime-dom.esm-bundler-74b89f18.js';
import { s as setupDevtoolsPlugin } from './common/index-b10f8e18.js';
        ...
        if (isNumber(ret) && ret === NOT_REOSLVED) {
            ...
            if ((process.env.NODE_ENV !== 'production') &&
                ...
                if (_fallbackRoot &&
                    ...
                    warn(getWarnMessage$1(I18nWarnCodes.FALLBACK_TO_ROOT, {
                        key,
                        type: warnType
                    }));
                }
...
function convertComposerOptions(options) {
    ...
    if ((process.env.NODE_ENV !== 'production') && options.formatter) {
        warn(getWarnMessage$1(I18nWarnCodes.NOT_SUPPORTED_FORMATTER));
    }
    if ((process.env.NODE_ENV !== 'production') && options.preserveDirectiveContent) {
        warn(getWarnMessage$1(I18nWarnCodes.NOT_SUPPORTED_PRESERVE_DIRECTIVE));
    }
...
function createVueI18n(options = {}, VueI18nLegacy) {
    {
        ...
        const vueI18n = {
            ...
            // formatter
            get formatter() {
                (process.env.NODE_ENV !== 'production') && warn(getWarnMessage$1(I18nWarnCodes.NOT_SUPPORTED_FORMATTER));
                // dummy
                return {
                    interpolate() {
                        return [];
            ...
            getChoiceIndex(choice, choicesLength) {
                (process.env.NODE_ENV !== 'production') &&
                    warn(getWarnMessage$1(I18nWarnCodes.NOT_SUPPORTED_GET_CHOICE_INDEX));
                return -1;
            },
            // for internal
...
function vTDirective(i18n) {
    const _process = (binding) => {
        ...
        if ((process.env.NODE_ENV !== 'production') && modifiers.preserve) {
            warn(getWarnMessage$1(I18nWarnCodes.NOT_SUPPORTED_PRESERVE));
        }
...
function apply(app, i18n, ...options) {
    ...
    if ((process.env.NODE_ENV !== 'production') && globalInstall && useI18nComponentName) {
        warn(getWarnMessage$1(I18nWarnCodes.COMPONENT_NAME_LEGACY_COMPATIBLE, {
...
function useI18n(options = {}) {
    ...
    if (scope === 'parent') {
        ...
        if (composer == null) {
            if ((process.env.NODE_ENV !== 'production')) {
                warn(getWarnMessage$1(I18nWarnCodes.NOT_FOUND_PARENT_SCOPE));
            }
            composer = global;
        }
        return composer;
...
export { DatetimeFormat, I18nInjectionKey, NumberFormat, Translation, VERSION$1 as VERSION, castToVueI18n, createI18n, useI18n, vTDirective };
