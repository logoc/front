<template>
  <Modal v-bind="getBindValue"  @cancel="handleCancel" :maskClosable="getProps.maskClosable" :fullscreen="fullscreenVal" :body-style="{padding:0}" modal-class="self-modal">
    ...
    <template #footer v-if="!$slots.footer">
      <ModalViewFooter v-bind="getBindValue"  :loading="getProps.loading" @ok="handleOk" @cancel="handleCancel">
...
<script lang="ts">
  ...
  import ModalViewFooter from './components/ModalViewFooter.vue';
  ...
  export default defineComponent({
    name: 'ViewModal',
    components: { Modal, ModalViewFooter, ModalHeader ,ModalWrapper},
    inheritAttrs: false,
    props: basicProps,
